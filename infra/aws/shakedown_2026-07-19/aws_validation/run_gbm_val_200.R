...
#
# Outputs: data/sim_results_v2_gbm/results-row-*  and sim_results_v2_gbm_val_200.rds
...
res <- runSimulation(
  ...
  filename = "sim_results_v2_gbm_val_200.rds",
  save_results = TRUE,
  save_details = list(save_results_dirname = "data/sim_results_v2_gbm_val_200")
)
