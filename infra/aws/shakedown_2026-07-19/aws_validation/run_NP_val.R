...
#
# Outputs: data/sim_results_v2_NP/results-row-*  and sim_results_v2_NP_val.rds
...
res <- runSimulation(
  ...
  filename = "sim_results_v2_NP_val.rds",
  save_results = TRUE,
  save_details = list(save_results_dirname = "data/sim_results_v2_NP_val")
)
