...
-   **Gradient Boosted Trees (GBM)**: boosted classification trees using the R *gbm* package, following the specification popularized for propensity score estimation by @McCaffrey.2004pse: Bernoulli deviance, depth-three trees, and a shrinkage rate of 0.05, with the number of boosting iterations selected by five-fold cross-validation.
