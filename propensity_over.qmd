...
The data generation mechanism for our simulation was informed by a large-scale evaluation we conducted of an AI chatbot intervention, which used high-dimensional administrative data. We based the coefficient values of the covariates and error variances on those data. By basing our simulation on real-world data, we aim to address the limitations of statistical simulations that may not generalize well to real datasets [@huber2013performance].
