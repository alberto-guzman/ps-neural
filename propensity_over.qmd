...
In total, I tested three different covariate conditions (p = 20, 100, 200) with varying levels of complexity in the treatment and outcome models (Treatment population model = Base, Complex; Outcome population model = Base, Complex). I evaluated nine propensity score estimation methods: logit, CART, bagged CART, random forest, GBM, Super Learner, NN-1, DNN-2, and DNN-3. The sample size was fixed at 10,000. By fully crossing all these conditions, I tested 108 scenarios; each simulated 1,000 times.
